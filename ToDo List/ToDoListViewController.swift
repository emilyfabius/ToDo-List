...
//    var toDoArray = ["Go to the gym", "Get covid test", "Email professor", "Finish class lecture"]
    ...
    func setNotifications() {
        ...
        // recreate notifications with updated data
...
extension ToDoListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        print("cell for row at was just called for indexPath.row = \(indexPath.row) which is the cell containing \(toDoItems[indexPath.row])")
